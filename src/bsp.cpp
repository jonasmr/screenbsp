...
#define BspCullObjectSSE2 BspCullObject
...
bool BspCullObjectSSE(SOccluderBsp *pBsp, SOccluderDesc* pObject, SOccluderBspNodes* pNodes)
{
	// if(0 == (pObject->nFlags & SObject::OCCLUSION_TEST))
	// 	return false;
	if(!pNodes)
	...
	//BspCullObjectSSE2(pBsp,pObject);
